...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "SurvivalDevelopFramework ÎÄµµ" /productName "SurvivalDevelopFramework ÎÄµµ"
