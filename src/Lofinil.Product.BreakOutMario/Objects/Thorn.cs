...
namespace BreakOutMario.Objects
{
    ...
    public class Thorn : Item
    {
        ...
        public override bool Update()
        {
            ...
            //        foreach (Terrain tt in SceneMgr.Instance.terrainMgr.ItemList)
            //        {
            //            // TODO 目前无像素碰撞检测，因此不要旋转地板
            //            if(rect.Intersects(tt.GetOrthoBound()))
            //            {
            ...
            //        {
            //            if(GetOrthoBound().Intersects(SceneMgr.Instance.askia.GetOrthoBound()))
            //            {
