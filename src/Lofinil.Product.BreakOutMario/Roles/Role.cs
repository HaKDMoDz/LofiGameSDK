    ...
    public class Role : Item
    {
        ...
        public override bool Update()
        {
            ...
            //{
                ...
                //if (!isHurting)
                //{
                //    if (HitByThorn() || (SceneMgr.Instance.askia != null && SceneMgr.Instance.askia.AskiaState== Askia.EAskiaState.Dashing && GetOrthoBound().Intersects(SceneMgr.Instance.askia.GetOrthoBound())))
                //    {
                //        isHurting = true;
                //        Health--;
                //        hurtTime = 0;
            ...
            // Input更新
            if (SceneManager.Instance.GetItemByName("Role") == this && !SceneManager.Instance.GTMActive) // TODO 需修改，将GTM融合进状态机 ...
                InputUpdate();
        ...
        //{
        //    bool getHit = false;
        //    Rectangle rect = GetOrthoBound();
        //    foreach (Thorn thorn in SceneMgr.Instance.thornMgr.ItemList)
        //    {
        //        if (rect.Intersects(thorn.GetOrthoBound()))
        //        {
        //            getHit = true;
        //            thorn.HitRole();
        //        }
